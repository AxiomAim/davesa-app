...
.sl-panel .sl-panel__footer button.sl-panel__done-button {
  width: auto;
  padding: var(--sjs-base-unit, var(--base-unit, 8px)) calc(4 * (var(--sjs-base-unit, var(--base-unit, 8px))));
...
/*!*****************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[1].use[2]!./src/components/tabs/theme-builder.scss ***!
  \*****************************************************************************************************************************************************************************************/
svc-tab-test {
  width: 100%;
  height: 100%;
...
.svc-creator-popup.sv-popup .sd-btn {
...
.svc-creator-popup.sv-popup .sd-btn:hover {
...
.svc-creator-popup.sv-popup .sd-btn--action {
...
.svc-creator-popup.sv-popup .sd-btn--action:hover {
...
.svc-creator-popup.sv-popup--modal > .sv-popup__container > .sv-popup__shadow > .sv-popup__body-content {
  background-color: var(--ctr-popup-background-color, var(--sjs-general-backcolor-dim-light, var(--background-dim-light, #f9f9f9)));
}
...
.svc-creator-popup.sv-popup--dropdown-overlay .sd-btn {
...
.svc-tab-designer--bypage-mode .svc-tab-designer__page-navigator .svc-page-navigator {
  padding-right: 0;
}
/*!*********************************************************************************************************************************************************************************************************!*\
...
.svc-element__add-new-question .svc-text {
...
.svc-panel__add-new-question-wrapper .svc-element__add-new-question .svc-text {
  display: flex;
  align-items: center;
  flex-grow: 1;
  justify-content: center;
...
.svc-panel__add-new-question-wrapper .svc-element__question-type-selector use {
  fill: var(--ctr-library-contextual-button-icon-color, var(--sjs-general-forecolor-light, var(--foreground-light, #909090)));
}
.svc-panel__add-new-question-wrapper .svc-element__question-type-selector:hover {
  background-color: var(--sjs-general-backcolor-dim, var(--background-dim, #f3f3f3));
}
.svc-panel__add-new-question-wrapper .svc-element__question-type-selector:focus {
  background-color: var(--sjs-primary-backcolor-light, var(--primary-light, rgba(25, 179, 148, 0.1)));
}
...
@container (max-width: 176px) {
  ...
  .svc-panel__placeholder_frame .svc-element__add-new-question .svc-text,
  .svc-panel__add-new-question-container .svc-panel__add-new-question .svc-text,
  .svc-panel__add-new-question-container .svc-element__add-new-question .svc-text {
    display: none;
  }
}
...
.svc-property-grid-placeholder__title {
  ...
  font-style: normal;
  font-weight: 600;
  line-height: var(--ctr-font-default-line-height, 24px);
  display: inline-block;
}
...
.svc-property-grid-placeholder__description {
  ...
  font-style: normal;
  font-weight: 400;
  line-height: var(--ctr-font-small-line-height, 16px);
  display: inline-block;
}
...
.svc-property-grid-placeholder__image {
  ...
  align-items: center;
  flex: 1 0 0;
  background: url(4d86d1950ecdfb59807f.png) 50%/contain no-repeat;
  width: 100%;
  overflow: hidden;
  height: 86px;
}
...
.svc-toolbox-subtypes .sv-popup__shadow {
  box-shadow: unset;
}
...
.svc-flyout-side-bar.svc-side-bar--enter .svc-side-bar__shadow,
.svc-flyout-side-bar.svc-side-bar--leave .svc-side-bar__shadow {
  animation-fill-mode: forwards;
  animation-name: flyoutSideBarShadowFadeIn;
}
.svc-flyout-side-bar.svc-side-bar--enter .svc-side-bar__wrapper,
.svc-flyout-side-bar.svc-side-bar--leave .svc-side-bar__wrapper {
  animation-fill-mode: forwards;
...
.svc-sidebar__header-container {
  display: flex;
  padding: var(--ctr-property-grid-header-padding-top, 12px) var(--ctr-property-grid-header-padding-right, 16px) var(--ctr-property-grid-header-padding-bottom, 12px) var(--ctr-property-grid-header-padding-left, 16px);
  justify-content: center;
  align-items: center;
  flex: 1 0 0;
  align-self: stretch;
...
.spg-table__cell:not(.spg-table__cell--detail-panel) .spg-dropdown {
  ...
  background-image: url("data:image/svg+xml,%3Csvg width=%2724%27 height=%2724%27 viewBox=%270 0 24 24%27 fill=%27none%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cpath d=%27M12 15L17 10H7L12 15Z%27 fill=%27%2390909080%27/%3E%3C/svg%3E%0A");
  background-repeat: no-repeat;
}
...
.spg-root-modern .sv-button-group {
  ...
  transition: box-shadow var(--sjs-creator-transition-duration, 150ms), border-color var(--sjs-creator-transition-duration, 150ms), border var(--sjs-creator-transition-duration, 150ms);
}
