...
export class SplitGutterExcludeFromDragDirective {
    ...
    /** @nocollapse */ static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.2", ngImport: i0, type: SplitGutterExcludeFromDragDirective, deps: [{ token: GUTTER_NUM_TOKEN }, { token: i0.ElementRef }, { token: i1.SplitGutterDirective }], target: i0.ɵɵFactoryTarget.Directive }); }
