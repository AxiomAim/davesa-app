...
class AdaptiveToolboxComponent extends BaseAngular {
    ...
    ngAfterViewInit() {
        ...
        this.responsivityManager =
            new VerticalResponsivityManager(this.model.containerElement, this.model, this.model.itemSelector);
    }
    getModel() {
        return this.model;
    }
...
QuestionPgErrorComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: QuestionPgErrorComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
QuestionPgErrorComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: QuestionPgErrorComponent, selector: "svc-question-error", inputs: { error: "error", cssClasses: "cssClasses", element: "element" }, ngImport: i0, template: "<div>\n  <svg [class]=\"cssClasses.error.icon\" [iconName]=\"('icon-alert_24x24')\" [size]=\"24\" sv-ng-svg-icon></svg>\n  <span [class]=\"cssClasses ? cssClasses.error.item : 'panel-error-item'\" [model]=\"error.locText\" sv-ng-string>\n  </span>\n</div>", components: [{ type: i1.SvgIconComponent, selector: "'[sv-ng-svg-icon]'", inputs: ["size", "width", "height", "iconName", "partCss", "css", "title"] }, { type: i1.SurveyStringComponent, selector: "sv-ng-string, '[sv-ng-string]'", inputs: ["model"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: QuestionPgErrorComponent, decorators: [{
            type: Component,
            args: [{
...
SwitcherComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: SwitcherComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
SwitcherComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: SwitcherComponent, selector: "svc-switcher", inputs: { model: "model" }, usesInheritance: true, ngImport: i0, template: "<ng-template #template>\n  <button type=\"button\" (click)=\"model.action(model, model.getIsTrusted($event))\"\n    [key2click]=\"{ processEsc: false, disableTabStop: model.disableTabStop }\" [class]=\"model.getActionBarItemCss()\"\n    [disabled]=\"model.disabled\" [attr.title]=\"model.tooltip || model.title\" [attr.aria-checked]=\"model.ariaChecked\"\n    [attr.aria-expanded]=\"model.ariaExpanded\" [attr.role]=\"model.ariaRole\">\n    <div [class]=\"model.getSwitcherIconCss()\">\n      <div class=\"svc-switcher__icon-thumb\"></div>\n    </div>\n    <span *ngIf=\"model.hasTitle\" class=\"svc-switcher__title\">{{ model.title }}</span>\n  </button>\n  <ng-template>", styles: [":host { display: none; }"], directives: [{ type: i1.Key2ClickDirective, selector: "[key2click]", inputs: ["key2click"] }, { type: i2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }] });
...
ToolboxListComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: ToolboxListComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
ToolboxListComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: ToolboxListComponent, selector: "svc-toolbox-list ", inputs: { model: "model", creator: "creator" }, usesInheritance: true, ngImport: i0, template: "<ng-template #template>\n  <div [class]=\"model.cssClasses.root\">\n    <ng-container *ngFor=\"let item of model.renderedActions\">\n      <svc-toolbox-tool [item]=\"item\" [creator]=\"creator\" [parentModel]=\"model\" [isCompact]=\"false\"></svc-toolbox-tool>\n    </ng-container>\n  </div>\n</ng-template>", styles: [":host { display: none; }"], components: [{ type: ToolboxToolComponent, selector: "svc-toolbox-tool", inputs: ["creator", "item", "parentModel", "isCompact"] }], directives: [{ type: i2.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: ToolboxListComponent, decorators: [{
            type: Component,
            args: [{
...
QuestionTextWithResetComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: QuestionTextWithResetComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
QuestionTextWithResetComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: QuestionTextWithResetComponent, selector: "svc-text-with-reset", usesInheritance: true, ngImport: i0, template: "<div [class]=\"model.getRootClass()\">\n    <ng-template [component]=\"{ name: getComponentName(), data: { model } }\"></ng-template>\n    <button [class]=\"model.cssClasses.resetButton\" [disabled]=\"model.resetValueAdorner.isDisabled\"\n        (click)=\"model.resetValueAdorner.resetValue()\" [attr.title]=\"model.resetValueAdorner.caption\">\n        <svg [iconName]=\"model.cssClasses.resetButtonIcon\" size=\"'auto'\" sv-ng-svg-icon></svg>\n    </button>\n</div>", components: [{ type: i1.SvgIconComponent, selector: "'[sv-ng-svg-icon]'", inputs: ["size", "width", "height", "iconName", "partCss", "css", "title"] }], directives: [{ type: i1.DynamicComponentDirective, selector: "[component]", inputs: ["component"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: QuestionTextWithResetComponent, decorators: [{
            type: Component,
            args: [{
...
TranslateFromAction.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: TranslateFromAction, deps: null, target: i0.ɵɵFactoryTarget.Component });
TranslateFromAction.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: TranslateFromAction, selector: "svc-translate-from-action", inputs: { model: "model" }, usesInheritance: true, ngImport: i0, template: "<ng-template #template>\n    <div [class]=\"model.data.containerCss\">\n        <span [class]=\"model.data.additionalTitleCss\">{{model.data.additionalTitle}}</span>\n        <sv-action-bar-item-dropdown [model]=\"model\"></sv-action-bar-item-dropdown>\n    </div>\n</ng-template>", styles: [":host { display: none; }"], components: [{ type: i1.ActionBarItemDropdownComponent, selector: "sv-action-bar-item-dropdown", inputs: ["model"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: TranslateFromAction, decorators: [{
            type: Component,
            args: [{
