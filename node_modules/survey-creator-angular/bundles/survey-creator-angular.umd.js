(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var TextareaJsonEditorComponent = /** @class */ (function (_super) {
      ...
      TextareaJsonEditorComponent.prototype.ngAfterViewInit = function () {
  ...
  var QuestionPgErrorComponent = /** @class */ (function () {
      function QuestionPgErrorComponent() {
      }
      return QuestionPgErrorComponent;
  }());
  QuestionPgErrorComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: QuestionPgErrorComponent, deps: [], target: i0__namespace.ɵɵFactoryTarget.Component });
  QuestionPgErrorComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: QuestionPgErrorComponent, selector: "svc-question-error", inputs: { error: "error", cssClasses: "cssClasses", element: "element" }, ngImport: i0__namespace, template: "<div>\n  <svg [class]=\"cssClasses.error.icon\" [iconName]=\"('icon-alert_24x24')\" [size]=\"24\" sv-ng-svg-icon></svg>\n  <span [class]=\"cssClasses ? cssClasses.error.item : 'panel-error-item'\" [model]=\"error.locText\" sv-ng-string>\n  </span>\n</div>", components: [{ type: i1__namespace.SvgIconComponent, selector: "'[sv-ng-svg-icon]'", inputs: ["size", "width", "height", "iconName", "partCss", "css", "title"] }, { type: i1__namespace.SurveyStringComponent, selector: "sv-ng-string, '[sv-ng-string]'", inputs: ["model"] }] });
  i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: QuestionPgErrorComponent, decorators: [{
              type: i0.Component,
              args: [{
  ...
  i1.AngularComponentFactory.Instance.registerComponent("svc-question-error", QuestionPgErrorComponent);
  ...
  i1.AngularComponentFactory.Instance.registerComponent("svc-question-banner", QuestionBannerComponent);
  ...
  var ItemValueDesignerComponent = /** @class */ (function (_super) {
      ...
      ItemValueDesignerComponent.prototype.setupContainer = function () {
          var _a;
      ...
      ItemValueDesignerComponent.prototype.cleanContainer = function (item) {
          if (!!item) {
      ...
      ItemValueDesignerComponent.prototype.ngAfterViewInit = function () {
          this.setupContainer();
      };
  ...
  var StringEditorComponent = /** @class */ (function (_super) {
      ...
      StringEditorComponent.prototype.onPaste = function (event) {
  ...
  var LogicOperatorComponent = /** @class */ (function (_super) {
      ...
      LogicOperatorComponent.prototype.ngOnInit = function () {
          ...
          surveyCreatorCore.initLogicOperator(this.model);
      };
  ...
  var ColorItemComponent = /** @class */ (function (_super) {
      ...
      ColorItemComponent.prototype.getModel = function () {
          return this.model;
      };
      ColorItemComponent.prototype.getStyle = function () {
          return { backgroundColor: this.model.value };
      };
      return ColorItemComponent;
  }(i1.BaseAngular));
  ColorItemComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ColorItemComponent, deps: null, target: i0__namespace.ɵɵFactoryTarget.Component });
  ColorItemComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: ColorItemComponent, selector: "svc-color-item", inputs: { model: "model" }, usesInheritance: true, ngImport: i0__namespace, template: "<ng-template #template>\n  <span class=\"spg-color-editor__color-swatch\" [style]=\"getStyle()\"></span>\n  <sv-ng-string [model]=\"model.locTitle\"></sv-ng-string>\n</ng-template>", styles: [":host { display: none }"], components: [{ type: i1__namespace.SurveyStringComponent, selector: "sv-ng-string, '[sv-ng-string]'", inputs: ["model"] }] });
  i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ColorItemComponent, decorators: [{
              type: i0.Component,
              args: [{
  ...
  i1.AngularComponentFactory.Instance.registerComponent("color-item", ColorItemComponent);
  ...
  var JsonErrorItemComponent = /** @class */ (function (_super) {
      ...
      JsonErrorItemComponent.prototype.getModel = function () {
          return this.model;
      };
      JsonErrorItemComponent.prototype.fixError = function (event) {
          event.stopPropagation();
          this.model.data.fixError();
      };
      return JsonErrorItemComponent;
  }(i1.BaseAngular));
  JsonErrorItemComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: JsonErrorItemComponent, deps: null, target: i0__namespace.ɵɵFactoryTarget.Component });
  JsonErrorItemComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: JsonErrorItemComponent, selector: "svc-json-error-item", inputs: { model: "model" }, usesInheritance: true, ngImport: i0__namespace, template: "<ng-template #template>\n    <svg [iconName]=\"model.iconName\" [size]=\"model.iconSize\" [css]=\"'svc-json-error__icon'\" sv-ng-svg-icon></svg>\n    <div class=\"svc-json-error__container\">\n        <div class=\"svc-json-error__title\">\n            <sv-ng-string [model]=\"model.locTitle\"></sv-ng-string>\n        </div>\n        <button type=\"button\" *ngIf=\"model.data.showFixButton\" (click)=\"fixError($event)\" [key2click]\n            [attr.title]=\"model.data.fixButtonTitle\" [attr.aria-label]=\"model.data.fixButtonTitle\"\n            class=\"svc-json-error__fix-button\">\n            <svg [iconName]=\"model.data.fixButtonIcon\" [size]=\"'auto'\" sv-ng-svg-icon></svg>\n        </button>\n    </div>\n</ng-template>", styles: [":host { display: none }"], components: [{ type: i1__namespace.SvgIconComponent, selector: "'[sv-ng-svg-icon]'", inputs: ["size", "width", "height", "iconName", "partCss", "css", "title"] }, { type: i1__namespace.SurveyStringComponent, selector: "sv-ng-string, '[sv-ng-string]'", inputs: ["model"] }], directives: [{ type: i2__namespace.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i1__namespace.Key2ClickDirective, selector: "[key2click]", inputs: ["key2click"] }] });
  i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: JsonErrorItemComponent, decorators: [{
              type: i0.Component,
              args: [{
  ...
  exports.QuestionPgErrorComponent = QuestionPgErrorComponent;
