...
var CommandHandler = /** @class */ (function () {
    function CommandHandler(diagram) {
        ...
        this.moveSBObject = function (targetId) {
            if (targetId) {
                this.moveBackUndoNode(targetId);
                var node = this.diagram.getObject(targetId);
        ...
        this.moveBackUndoNode = function (targetId) {
            var originalZIndexTable = {}; // New variable to store original zIndex values
            // Store original zIndex values
            for (var i = 0; i < this.diagram.nodes.length; i++) {
                var node1 = this.diagram.nodes[parseInt(i.toString(), 10)];
                originalZIndexTable[node1.id] = node1.zIndex;
            }
            for (var j = 0; j < this.diagram.connectors.length; j++) {
                var connector = this.diagram.connectors[parseInt(j.toString(), 10)];
                originalZIndexTable[connector.id] = connector.zIndex;
            }
            var sortedNodeIds = Object.keys(originalZIndexTable).sort(function (a, b) { return originalZIndexTable["" + a] - originalZIndexTable["" + b]; });
            var currentIndex = sortedNodeIds.indexOf(targetId);
            ...
            if (currentIndex !== -1) {
                if (currentIndex == sortedNodeIds.length - 1) {
                    ...
                    if (nextNodeId) {
                        ...
                        var backNode = getDiagramElement(nextNodeId + '_groupElement', this.diagram.element.id);
                    ...
                    if (nextNodeId) {
                        ...
                        var target = this.diagram.getObject(targetId);
                        var newnode = this.diagram.getObject(nextNodeId);
        ...
        this.moveFBObject = function (targetId) {
            if (targetId) {
        ...
        this.moveForwardUndoNode = function (targetID) {
            var originalZIndexTable = {}; // New variable to store original zIndex values
            // Store original zIndex values
            for (var i = 0; i < this.diagram.nodes.length; i++) {
                var node1 = this.diagram.nodes[parseInt(i.toString(), 10)];
    ...
    CommandHandler.prototype.moveObjects = function (objects, targetLayer) {
        ...
        for (var i = 0; i < objects.length; i++) {
            ...
            if (obj instanceof Node) {
                ...
                var detail = { sourceID: obj.sourceID, targetID: obj.targetID, sourcePortID: obj.sourcePortID, targetPortID: obj.targetPortID };
                connectorObjectsDetails["" + obj.id] = cloneObject(detail);
            }
        }
            ...
            for (var i = 0; i < objects.length; i++) {
                ...
                if (object.shape.type === 'SwimLane') {
                    for (var i_6 = tabelLength; i_6 >= index; i_6--) {
                        if (zIndexTable[parseInt(i_6.toString(), 10)] && !(this.diagram.nameTable[zIndexTable[parseInt(i_6.toString(), 10)]].parentId === objectName)) {
                            length_1 = i_6;
                ...
                if (obj_3.zIndex < maxZindex && obj_3.shape.type !== 'SwimLane') {
                    ...
                    obj_3.zIndex = maxZindex + ((objects.indexOf(obj_3) !== -1 ? objects.indexOf(obj_3) : 0) + 1);
                ...
                // }
                    ...
                    for (var i_7 = 0; i_7 <= index; i_7++) {
                        if (zIndexTable[parseInt(i_7.toString(), 10)] && this.diagram.nameTable[zIndexTable[parseInt(i_7.toString(), 10)]].parentId === objectName) {
                            if (childIndex === -1) {
                                childIndex = i_7;
                                tempIndex_1 = i_7;
                                break;
                    ...
                    for (var i_8 = 0; i_8 <= tabelLength; i_8++) {
                        if (tempTable[parseInt(i_8.toString(), 10)] && tempTable[parseInt(i_8.toString(), 10)] !== objectName && this.diagram.nameTable[tempTable[parseInt(i_8.toString(), 10)]].parentId !== objectName) {
    ...
    CommandHandler.prototype.orderCommands = function (isRedo, selector, action) {
        ...
        if (isRedo) {
            ...
            var startZIndex_1 = selectedObject[0].zIndex;
            ...
            if (this.diagram.mode === 'SVG') {
                ...
                // }
                    ...
                    if (selectedObject[0].shape.type !== 'SwimLane') {
                        ...
                        //     }
                        // }
                        var zIndexArray = layer.objects.map(function (x) { return _this.diagram.nameTable["" + x].zIndex; });
                        var filteredZIndexArray = zIndexArray.filter(function (zIndex) { return zIndex > startZIndex_1; });
                        var filteredZIndexArray2 = zIndexArray.filter(function (zIndex) { return zIndex < startZIndex_1; });
                        var nextLowestZindex = filteredZIndexArray2.length > 0 ? Math.max.apply(Math, filteredZIndexArray2) : startZIndex_1;
                        var nextGreatestZIndex = filteredZIndexArray.length > 0 ? Math.min.apply(Math, filteredZIndexArray) : startZIndex_1;
                        if (startZIndex_1 !== nextGreatestZIndex) {
                            var first = layer.zIndexTable[parseInt(nextGreatestZIndex.toString(), 10)];
                            var second = layer.zIndexTable[parseInt(startZIndex_1.toString(), 10)];
                            this.moveSvgNode(second, first);
                        }
                        else if (action === 'SendToBack') {
                            var first = layer.zIndexTable[parseInt(startZIndex_1.toString(), 10)];
                            var second = layer.zIndexTable[parseInt(nextLowestZindex.toString(), 10)];
    ...
    CommandHandler.prototype.sendForward = function (obj) {
        ...
        if (hasSelection(this.diagram) || obj) {
            ...
            var originalNameTable_1 = cloneObject(this.diagram.nameTable);
            ...
            if (intersectArray.length > 0) {
                var node = this.diagram.nameTable[intersectArray[intersectArray.length - 1].id];
                if (node.parentId) {
                    var parentId = '';
                    var parent_1 = findParentInSwimlane(node, this.diagram, parentId);
                    var obj_5 = this.diagram.nameTable["" + parent_1];
                    if (obj_5.id !== nodeId) {
                        intersectArray[0] = obj_5;
                    }
                }
                var originalZIndexTable = {}; // New variable to store original zIndex values
                ...
                if (index) {
                    ...
                    if (Object.keys(zIndex_1).length > 0) {
                        ...
                        if (greaterItems_1.length !== 0) {
                            this.updateZIndexBySendForward(index, greaterItems_1);
                        }
                    }
                }
                var changedNodeZIndexesArray_1 = [];
                Object.keys(this.changedNodeZIndexes).forEach(function (nodeId) {
                    var originalZIndex = originalNameTable_1["" + nodeId] ? originalNameTable_1["" + nodeId].zIndex : null;
                    ...
                    if (originalZIndex !== changedZIndex) {
                        var node_2 = cloneObject(originalNameTable_1["" + nodeId]);
                        changedNodeZIndexesArray_1.push(node_2);
                    }
                });
                this.updateLayerZindexTable(layerIndex);
                undoObject_2.nodes.splice(0, undoObject_2.nodes.length);
                changedNodeZIndexesArray_1.forEach(function (node) {
                    var clonedNode = cloneObject(node);
                ...
                redoObject_1.nodes.splice(0, redoObject_1.nodes.length);
                changeNodeZIndexesArray_1.forEach(function (node) {
                    var clonedNode = cloneObject(node);
                    redoObject_1.nodes.push(clonedNode);
                });
                var historyEntry = {
                    type: 'SendForward', category: 'Internal',
                    undoObject: undoObject_2, redoObject: redoObject_1
                };
                if (!(this.diagram.diagramActions & DiagramAction.UndoRedo)) {
    ...
    CommandHandler.prototype.updateZIndexBySendForward = function (selectedNode, greaterItems) {
        var clonedNode = cloneObject(selectedNode);
        selectedNode.zIndex = Math.min.apply(Math, greaterItems);
        selectedNode.zIndex++;
        ...
        for (var i = 0; i < this.diagram.connectors.length; i++) {
            ...
            if (connector.zIndex >= selectedNode.zIndex && connector !== selectedNode) {
                var clonedNode_2 = cloneObject(connector);
                connector.zIndex++;
                this.triggerOrderCommand(clonedNode_2, connector, connector);
            }
            var originalZIndex = connector.zIndex;
     ...
     * @private
    */
    CommandHandler.prototype.moveForwardSvgNode = function (targetID) {
        var _this = this;
        var sortedNodeIds = Object.keys(this.changedNodeZIndexes).sort(function (a, b) { return _this.changedNodeZIndexes["" + a] - _this.changedNodeZIndexes["" + b]; });
        var currentIndex = sortedNodeIds.indexOf(targetID);
        if (currentIndex !== -1) {
    ...
    CommandHandler.prototype.sendBackward = function (obj) {
        ...
        if (hasSelection(this.diagram) || obj) {
            ...
            objectId = objectId || (this.diagram.selectedItems.nodes.length ? this.diagram.selectedItems.nodes[0].id
                : this.diagram.selectedItems.connectors[0].id);
            var layerNum = this.diagram.layers.indexOf(this.getObjectLayer(objectId));
            var originalNameTable_2 = cloneObject(this.diagram.nameTable);
            var zIndexTable = this.diagram.layers[parseInt(layerNum.toString(), 10)].zIndexTable;
            //const tabelLength: number = Object.keys(zIndexTable).length;
            ...
            if (intersectArray.length > 0) {
                ...
                if (child.parentId) {
                    ...
                    var obj_6 = this.diagram.nameTable["" + parent_2];
                    if (objectId !== obj_6.id) {
                        intersectArray[intersectArray.length - 1] = obj_6;
                    }
                }
                var originalZIndexTable = {}; // New variable to store original zIndex values
                // Store original zIndex values for nodes
                ...
                var undoObject_3 = cloneObject(this.diagram.selectedItems);
                this.diagram.startGroupAction();
                var zIndex_2 = {};
                intersectArray.forEach(function (item) {
                ...
                if (node) {
                    ...
                    if (Object.keys(zIndex_2).length > 0) {
                        ...
                        if (lesserItems_1.length !== 0) {
                            this.updateZIndexBySendBackward(node, lesserItems_1);
                        }
                    }
                }
                var changedNodeZIndexesArray_2 = [];
                Object.keys(this.changedNodeZIndexes).forEach(function (nodeId) {
                    var originalZIndex = originalNameTable_2["" + nodeId] ? originalNameTable_2["" + nodeId].zIndex : null;
                    var changedZIndex = _this.changedNodeZIndexes["" + nodeId];
                    //By comparing with changedNodeZIndexes to store the changed elements in undo
                    if (originalZIndex !== changedZIndex) {
                        var node_4 = cloneObject(originalNameTable_2["" + nodeId]);
                        changedNodeZIndexesArray_2.push(node_4);
                    }
                });
                this.updateLayerZindexTable(layerNum);
                undoObject_3.nodes.splice(0, undoObject_3.nodes.length);
                changedNodeZIndexesArray_2.forEach(function (node) {
                    var clonedNode = cloneObject(node);
                    undoObject_3.nodes.push(clonedNode);
                });
                if (this.diagram.mode === 'SVG') {
                    var nodeIdToUpdate = intersectArray[intersectArray.length - 1].id;
                    var element_1 = intersectArray[intersectArray.length - 1];
                    if (element_1 && !(element_1.shape.type === 'HTML'
                        || element_1.shape.type === 'Native')) {
                        this.moveBackSvgNode(objectId);
                    }
                    var node_5 = this.diagram.nameTable["" + nodeIdToUpdate];
                ...
                redoObject_2.nodes.splice(0, redoObject_2.nodes.length);
                changeNodeZIndexesArray_2.forEach(function (node) {
                    var clonedNode = cloneObject(node);
                    redoObject_2.nodes.push(clonedNode);
                });
                var entry = { type: 'SendBackward', category: 'Internal', undoObject: undoObject_3, redoObject: redoObject_2 };
                if (!(this.diagram.diagramActions & DiagramAction.UndoRedo)) {
                    this.addHistoryEntry(entry);
                }
                this.diagram.endGroupAction();
    ...
    //This method changes all the zindex values based on the selected node/connector 
    CommandHandler.prototype.updateZIndexBySendBackward = function (selectedNode, lesserItems) {
        var clonedNode = cloneObject(selectedNode);
        selectedNode.zIndex = Math.max.apply(Math, lesserItems);
        selectedNode.zIndex--;
        this.triggerOrderCommand(clonedNode, selectedNode, selectedNode);
        for (var i = 0; i < this.diagram.nodes.length; i++) {
            var node = this.diagram.nodes[parseInt(i.toString(), 10)];
            if (node.zIndex <= selectedNode.zIndex && node !== selectedNode) {
                var clonedNode_3 = cloneObject(node);
                node.zIndex--;
                this.triggerOrderCommand(clonedNode_3, node, node);
            }
            var originalZIndex = node.zIndex;
            if (this.changedNodeZIndexes.hasOwnProperty(node.id)) {
                this.changedNodeZIndexes["" + node.id] = originalZIndex;
        ...
        for (var i = 0; i < this.diagram.connectors.length; i++) {
            var connector = this.diagram.connectors[parseInt(i.toString(), 10)];
            if (connector.zIndex <= selectedNode.zIndex && connector !== selectedNode) {
                var clonedNode_4 = cloneObject(connector);
                connector.zIndex--;
                this.triggerOrderCommand(clonedNode_4, connector, connector);
            }
            var originalZIndex = connector.zIndex;
            if (this.changedNodeZIndexes.hasOwnProperty(connector.id)) {
                this.changedNodeZIndexes[connector.id] = originalZIndex;
     ...
     * @private
    */
    CommandHandler.prototype.moveBackSvgNode = function (targetID) {
        var _this = this;
        var sortedNodeIds = Object.keys(this.changedNodeZIndexes).sort(function (a, b) { return _this.changedNodeZIndexes["" + a] - _this.changedNodeZIndexes["" + b]; });
        var currentIndex = sortedNodeIds.indexOf(targetID);
        //This logic moves the node/connector based on their zindex
...
Remove terinal segment in initial
     ...
     * @private
     */
    CommandHandler.prototype.snapPoint = function (startPoint, endPoint, tx, ty, dragWrapper) {
        var obj = this.diagram.selectedItems;
        var point;
        ...
        if (this.snappingModule) {
            snappedPoint = this.diagram.snappingModule.snapPoint(this.diagram, obj, towardsLeft, towardsTop, point, startPoint, endPoint, dragWrapper);
        }
        return snappedPoint;
    };
    /**
