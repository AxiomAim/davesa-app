...
export declare class CommandHandler {
    ...
    private moveSBObject;
    private moveBackUndoNode;
    private moveFBObject;
    private moveForwardUndoNode;
    private moveObject;
    /**
     * sendForward method\
     *
     ...
     * @private
    */
    moveForwardSvgNode(targetID: string): void;
    /**
     * sendBackward method\
     *
     ...
     * @private
    */
    moveBackSvgNode(targetID: string): void;
    /**
...
Remove terinal segment in initial
     ...
     * @private
     */
    snapPoint(startPoint: PointModel, endPoint: PointModel, tx: number, ty: number, dragWrapper?: Container): PointModel;
    /**
     * @private
     */
    removeSnap(): void;
