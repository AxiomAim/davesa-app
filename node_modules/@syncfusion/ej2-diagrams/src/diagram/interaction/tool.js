...
var MoveTool = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        snappedPoint = this.commandHandler.snapPoint(this.prevPosition, this.currentPosition, 0, 0, this.dragWrapper);
                        this.commandHandler.removeSnap();
    ...
    MoveTool.prototype.mouseMove = function (args) {
        ...
        if (this.objectType !== 'Port') {
            ...
            if (this.currentTarget === null && this.commandHandler.diagram.selectedItems.nodes.length > 0 && !this.commandHandler.diagram.selectedItems.nodes[0].parentId.includes('swimlane')) {
                if (this.commandHandler.diagram.selectedItems.nodes[0].shape.type !== 'SwimLane') {
                    var dragNode = this.commandHandler.diagram.selectedItems.nodes[0];
                    this.dragWrapper = dragNode.wrapper;
                }
            }
            var snappedPoint = this.commandHandler.snapPoint(this.prevPosition, this.currentPosition, diffX, diffY, this.dragWrapper);
