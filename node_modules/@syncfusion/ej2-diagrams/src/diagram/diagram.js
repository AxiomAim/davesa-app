        ...
        if (obj !== undefined) {
            ...
            if (!this.refreshing) {
                ...
                if (obj.shape.annotations && obj.shape.annotations.length > 0) {
                    for (var i = 0; i < obj.shape.annotations.length && obj.shape.annotations[parseInt(i.toString(), 10)].text; i++) {
    ...
    */
    ...
    Diagram.prototype.renderDiagramElements = function (canvas, renderer, htmlLayer, transform, fromExport, isOverView) {
        ...
        for (var _i = 0, _a = Object.keys(this.layerZIndexTable); _i < _a.length; _i++) {
            ...
            layerObjects.sort(function (a, b) { return parseInt("" + a) - parseInt("" + b); });
    ...
    Diagram.prototype.navigateItems = function (tabCommand) {
        ...
        for (var i = 0; i < this.nodes.length; i++) {
            if (currentSelectedNodeIndex === this.nodes[parseInt(i.toString(), 10)].zIndex) {
                var nextNode = this.nodes[parseInt(i.toString(), 10)];
                this.clearSelection();
        ...
        for (var j = 0; j < this.connectors.length; j++) {
            if (currentSelectedNodeIndex === this.connectors[parseInt(j.toString(), 10)].zIndex) {
                var nextConnector = this.connectors[parseInt(j.toString(), 10)];
                this.clearSelection();
    ...
    Diagram.prototype.endEdit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var blazor, blazorInterop, oldValues, changedvalues, annotations, textArea, text, element, node, annotation, args, textWrapper, index, deleteNode, eventObj, index, changesAnnotation, nodeIndex, oldnodes, newnodes, clonedObject, selectedNode, swimLaneNode, laneHeader, phaseHeader, collection, j;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.diagramActions & DiagramAction.TextEdit)) return [3 /*break*/, 5];
                        blazor = 'Blazor';
                        ...
                        if (!((isBlazor() && textArea) || !isBlazor())) return [3 /*break*/, 5];
                        text = textArea.value;
                        ...
                        if (!(!deleteNode && (element.textContent !== text || text !== this.activeLabel.text))) return [3 /*break*/, 4];
                        if (!isBlazor()) return [3 /*break*/, 3];
                        if (!(window && window["" + blazor] && this.textEdit)) return [3 /*break*/, 2];
    ...
    Diagram.prototype.nodePropertyChange = function (actualObject, oldObject, node, isLayout, rotate, propertyChange) {
        ...
        if (update) {
            if (this.bpmnModule !== undefined && offsetChanged && !sizeChanged && !angleChanged && !this.sizeUndo) {
                // eslint-disable-next-line max-len
                this.updateBpmnAnnotationPosition(oldBpmnOffsetX, oldBpmnOffsetY, newBpmnOffsetX, newBpmnOffsetY, actualObject, actualObject.wrapper, actualObject.shape, actualObject.shape.shape === 'TextAnnotation');
            }
    ...
    Diagram.prototype.updateBpmnAnnotationPosition = function (oldX, oldY, newX, newY, node, wrapper, shape, isTextAnnotation) {
        ...
        if (isTextAnnotation) {
            ...
            for (var _i = 0, _a = node.outEdges; _i < _a.length; _i++) {
                ...
                if (connector && connector.isBpmnAnnotationConnector) {
                    var targetNode = this.nameTable[connector.targetID];
                    if (targetNode.shape.shape === "TextAnnotation") {
                            ...
                            if (sourceElement["" + selectedSymbols] instanceof Node) {
                                ...
                                if (newNode.shape.type === 'UmlClassifier') {
                                    ...
                                    if (newNode.shape.classifier == "Class") {
                                        if (newNode.shape.classShape.methods.length <= 0 && newNode.shape.classShape.attributes.length <= 0) {
                                    ...
                                    if (newNode.shape.classifier == "Interface") {
                                        if (newNode.shape.interfaceShape.methods.length <= 0 && newNode.shape.interfaceShape.attributes.length <= 0) {
