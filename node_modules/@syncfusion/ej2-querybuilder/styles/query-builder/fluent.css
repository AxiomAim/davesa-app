...
.e-query-builder.e-device .e-dropdown-btn.e-round.e-small .e-add-icon,
.e-bigger.e-query-builder .e-dropdown-btn.e-round.e-small .e-add-icon,
.e-bigger .e-query-builder .e-dropdown-btn.e-round.e-small .e-add-icon {
  line-height: 0.8em !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-query-builder .e-group-header .e-clone-grp-btn, .e-query-builder .e-group-header .e-lock-grp-btn {
  background: #f3f2f1;
  border: 0 solid #f3f2f1;
}
.e-query-builder .e-group-container {
