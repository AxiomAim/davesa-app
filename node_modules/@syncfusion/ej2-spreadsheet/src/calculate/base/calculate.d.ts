...
export declare class Calculate extends Base<HTMLElement> implements INotifyPropertyChanged {
    ...
    computeVHLookup(range: string[], vLookup?: boolean): string;
     ...
     */
    getValueFromArg(arg: string, isUnique?: boolean, isIfError?: boolean, isSubtotal?: boolean): string;
     ...
     */
    calculateAvg(args: string[], isSubtotalFormula?: boolean): string;
    /**
     * @hidden
