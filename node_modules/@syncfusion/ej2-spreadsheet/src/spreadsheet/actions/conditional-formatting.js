                ...
                if (!isApply && args.isEdit && !isEditCellUpdated) {
                    ...
                    if (cf.cFColor) {
                        ...
                        if (Object.keys(style_1).length) {
                            _this.parent.notify(applyCellFormat, { style: style_1, rowIdx: rIdx, colIdx: cIdx, td: td });
                        }
                    }
                }
            }
        ...
        if (isNaN(value)) {
            if (td.style.backgroundColor) {
                ...
                if (style.backgroundColor) {
                    this.parent.notify(applyCellFormat, { style: { backgroundColor: style.backgroundColor }, td: td, rowIdx: rIdx,
                        colIdx: cIdx });
                }
            }
            return;
