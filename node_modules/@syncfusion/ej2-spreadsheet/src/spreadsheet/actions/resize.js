...
import { setResize, autoFit, completeAction, setAutoFit } from '../common/index';
        ...
        if (isCol) {
            ...
            for (var colIdx = 0; colIdx < colLength; colIdx++) {
                ...
                if (cell) {
                    ...
                    colGrp.appendChild(this.parent.createElement('col', { styles: "width:" + getColumnWidth(sheet, colIdx, false, true) + "px" }));
                }
            }
