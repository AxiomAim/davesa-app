...
var SpreadsheetImage = /** @class */ (function () {
    ...
    SpreadsheetImage.prototype.deleteImage = function (args) {
        ...
        if (!args.preventEventTrigger) {
            this.parent.notify(completeAction, { action: 'deleteImage', eventArgs: { address: address, id: image.id, imageData: image.src, imageWidth: image.width, imageHeight: image.height, cancel: false } });
        }
    };
    /**
