...
import { locale, dialog, mouseDown, renderFilterCell, initiateFilterUI, getStartEvent, focus, getChartsIndexes, refreshChartCellModel } from '../index';
import { reapplyFilter, filterCellKeyDown, refreshFilterRange } from '../index';
...
import { getComponent, EventHandler, isUndefined, isNullOrUndefined, Browser, removeClass } from '@syncfusion/ej2-base';
import { detach, classList, getNumericObject, getNumberDependable, defaultCurrencyCode } from '@syncfusion/ej2-base';
...
var Filter = /** @class */ (function () {
    ...
    Filter.prototype.refreshFilterRange = function (filterRange, remove, sIdx, allowHeaderFilter) {
        ...
        var cell;
        var frozenCol = this.parent.frozenColCount(getSheet(this.parent, sheetIdx));
    ...
    Filter.prototype.initCboxList = function (args, excelFilter) {
        var _this = this;
            ...
            if (searchValue) {
                ...
                listData.forEach(function (data) {
                    if (data.toLowerCase().includes(searchValue)) {
                        ...
                        cBoxFrag.appendChild(
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        createCboxWithWrap(getUid('cbox'), excelFilter.createCheckbox(data, true, obj), 'e-ftrchk'));
                ...
                if (!searchedSelectedList.length) {
                    ...
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    getUid('cbox'), excelFilter.createCheckbox(obj[args.column.field], false, obj), 'e-ftrchk');
        ...
        var applyBtnClickHandler = function () {
            ...
            if (checkedLength === listData.length) {
                ...
                var curSymbol_1 = getNumberDependable(locale, defaultCurrencyCode);
                ...
                var updatePredicate = function (val) {
                    ...
                    if (type === 'number') {
                        ...
                        else if (!isNumber(parseLocaleNumber([val], _this.parent.locale, curSymbol_1, localeObj_1)[0])) {
                            type = 'string';
                        }
                    }
                ...
                if (checkedLength > listData.length / 2) {
                    ...
                    for (var idx = 0, len = listData.length; idx < len; idx++) {
                        if (selectedList.indexOf(listData[idx]) === -1) {
                            updatePredicate(listData[idx]);
                        }
                    }
                }
                else {
    ...
    Filter.prototype.openDialog = function (cell) {
        ...
        getData(this.parent, addr, true, true, null, true, null, null, false, fullAddr, null, templateColData).then(function (jsonData) {
            var checkBoxData;
            ...
            if (templateFilter) {
                if (templateColData || !otherColPredicate.length) {
                    ...
                    var data = new DataManager(jsonData).executeLocal(new Query().where(Predicate.and(_this.getPredicates(_this.getClonedPredicates(otherColPredicate)))));
                ...
                var beforeCboxRender_1 = function (args) {
                    ...
                    if (isDateCol) {
                        ...
                        _this.initCboxList(args, excelFilter);
                    }
                };
            ...
            var options = {
                ...
                hideSearchbox: false, filteredColumns: _this.getClonedPredicates(_this.filterCollection.get(sheetIdx)), column: filterCol,
    ...
    Filter.prototype.filterSuccessHandler = function (dataSource, args) {
        ...
        var filterOptions = { datasource: dataSource,
    ...
    Filter.prototype.getClonedPredicates = function (predicates) {
        var predicateCol = [];
        var predicate;
        for (var i = 0; i < predicates.length; i++) {
        ...
        if (this.filterRange.has(sheetIdx)) {
            ...
            if (predicates_2 && predicates_2.length) {
                ...
                getData(this.parent, addr, true, true, null, true, null, null, false, getRangeAddress(range)).then(function (jsonData) {
                    var predicate = _this.getPredicates(_this.getClonedPredicates(_this.filterCollection.get(sheetIdx)));
                    _this.applyFilter({ predicates: predicate, datasource: new DataManager(jsonData) }, getRangeAddress(filterRange_1.range), sheetIdx, [].slice.call(predicates_2), refresh, isInternal);
                });
            }
        }
    };
    ...
    Filter.prototype.setFilteredCollection = function (args) {
        ...
        if (filterArgs.hasFilter) {
            ...
            predicateMap.forEach(function (predicate, field) {
                ...
                var predicateCol = _this.getPredicates(predicate);
