...
import { ribbon, beforeRibbonCreate, removeDataValidation, clearViewer, initiateFilterUI, updateSortCollection } from '../common/index';
...
import { refreshRibbonIcons, beginAction, setCFRule, addFormatToCustomFormatDlg } from '../../workbook/common/index';
...
var Ribbon = /** @class */ (function () {
    ...
    Ribbon.prototype.createCFMenu = function (ul) {
        ...
        var iconSetGroup = this.parent.createElement('div', { id: 'is', className: 'e-is' });
        var iconSets = [{ hdr: 'Directional' },
        ...
        iconSets.forEach(function (iconSet, index) {
            iconSetEle = _this.parent.createElement('div', { id: "is" + (index + 1), className: "e-is" + (index + 1) });
            if (iconSet.hdr) {
                ...
                iconSet.cont.forEach(function (icon) {
                    ...
                    iconWrap = _this.parent.createElement('div', { id: icon.id || icon.key, className: "e-" + icon.cls + " e-is-wrapper",
                        attrs: { title: cultureText, 'aria-label': cultureText, tabindex: '-1' } });
                    for (countIdx = 0; countIdx < icon.count; countIdx++) {
                        iconWrap.appendChild(_this.createElement('span', "e-" + icon.cls + "-" + (countIdx + 1) + " e-iconsetspan"));
                    }
