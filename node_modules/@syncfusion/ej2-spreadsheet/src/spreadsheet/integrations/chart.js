...
import { initiateChart, getRangeIndexes, isNumber, getSheetIndexFromAddress, checkDateFormat, refreshChartCellOnInit } from '../../workbook/common/index';
...
var SpreadsheetChart = /** @class */ (function () {
    ...
    SpreadsheetChart.prototype.processChartRange = function (range, dataSheetIdx, opt) {
        ...
        var getPropertyValue = function (rIdx, cIdx, sheetIndex, checkDateTime) {
            var cell = getCell(rIdx, cIdx, getSheet(_this.parent, sheetIndex));
            if (cell) {
                var value = void 0;
                if (cell.format) {
        ...
        var trVal = getPropertyValue(minr, maxc, dataSheetIdx, true);
        var blVal = getPropertyValue(maxr, minc, dataSheetIdx);
        var tlVal = getPropertyValue(minr, minc, dataSheetIdx);
        ...
        while (i < diff) {
            ...
            while (j < len) {
                if (yValue[yInc]) {
                    ...
                    if (isNullOrUndefined(xValue[j]) && !isNullOrUndefined(val)) {
