...
var CellRenderer = /** @class */ (function () {
    ...
    CellRenderer.prototype.update = function (args) {
        ...
        if (args.cell && !isNullOrUndefined(args.cell.wrap)) {
            this.parent.notify(wrapEvent, {
                range: [args.rowIdx, args.colIdx, args.rowIdx, args.colIdx], wrap: args.cell.wrap, sheet: sheet, initial: true, td: args.td, row: args.row, hRow: args.hRow, isCustomHgt: !args.isRefresh && getRowHeight(sheet, args.rowIdx) > 20
            });
        }
    ...
    CellRenderer.prototype.calculateFormula = function (args) {
        ...
        args.cell.formula = args.cell.formula.indexOf('^+') > -1 || args.cell.formula.indexOf('&+') > -1 ? eventArgs.value : args.cell.formula; // for correcting the formulas 5^+3=>5^3 and 5&+3=>5&3 while rendering like Excel.
    };
     ...
     * @returns {void}
     */
    CellRenderer.prototype.refreshRange = function (range, refreshing, checkWrap, checkHeight, checkCF, skipFormatCheck, checkFormulaAdded) {
        var sheet = this.parent.getActiveSheet();
