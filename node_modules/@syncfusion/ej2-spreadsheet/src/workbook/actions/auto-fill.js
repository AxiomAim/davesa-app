...
import { checkDateFormat, parseFormulaArgument } from '../common/index';
/**
...
var WorkbookAutoFill = /** @class */ (function () {
    ...
    WorkbookAutoFill.prototype.autoFill = function (options) {
        ...
        var autoFillOptions = { dataRange: dataRangeIndices, fillRange: fillRangeIndices, direction: options.direction, fillType: options.fillType || this.fillInfo.fillType, sheetIndex: getSheetIndexFromAddress(this.parent, options.dataRange) };
