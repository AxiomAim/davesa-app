...
import { getSingleSelectedRange, getCell, getSheetIndex, checkFormulaRef, parseFormulaArgument } from '../index';
        ...
        dependentCell.forEach(function (dependentCellRefs, cellRef) {
            dependentCellRefs.forEach(function (dependentCellRef) {
                ...
                if (!isNullOrUndefined(fInfo)) {
                    ...
                    var namedRange_1 = false;
                    if (!formulaVal.includes(delSheetName) && definedNames && definedNames.size) {
                        var replacedValues = formulaVal.replace(/\w+/g, function (key) {
                    ...
                    if (sheetNameIdx > -1) {
                        ...
                        _this.updateDataContainer([rowId - 1, colId - 1], { value: formulaVal, visible: false, isNamedRange: namedRange_1, sheetId: family.tokenToParentObject.has(token) ?
                ...
                if (formulaStr) {
                    ...
                    for (var idx = 0; idx < cellRefArr.length; idx++) {
                        ...
                        if (cellRef_1.includes('!')) {
                            ...
                            sheetName_1 = refArr[0].split('\'').join('');
                            cellRef_1 = refArr[1];
                        }
                        else {
                            sheetName_1 = '';
