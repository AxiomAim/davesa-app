...
var WorkbookSave = /** @class */ (function (_super) {
     ...
     */
    WorkbookSave.prototype.processSheets = function (autoDetectFormat) {
        var _this = this;
        ...
        for (var sheetIdx = 0, sheetCount = this.parent.sheets.length; sheetIdx < sheetCount; sheetIdx++) {
            ...
            if (isNotLoaded) {
                var loadCompleteHandler = function (idx) {
                    executeTaskAsync(_this, _this.processSheet, _this.updateSheet, [_this.getStringifyObject(_this.parent.sheets[idx], skipProps, idx, false, true), idx]);
                };
                ...
                executeTaskAsync(this, this.processSheet, this.updateSheet, [this.getStringifyObject(sheet, skipProps, sheetIdx, autoDetectFormat && isDataBinding, true), sheetIdx]);
            }
        }
    };
    /**
                    ...
                    for (var i = 0, len = value.cells.length; i < len; i++) {
                        ...
                        if (cell) {
                            if (cell.value) {
                                ...
                                _this.parent.notify(workbookFormulaOperation, { action: 'refreshCalculate', value: cell.formula, rowIndex: cellIdx[0],
