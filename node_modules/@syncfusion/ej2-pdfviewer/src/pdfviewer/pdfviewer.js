    ...
    PdfViewer.prototype.updateFormFieldsValue = function (fieldValue) {
        ...
        if (target) {
            ...
            if (isNullOrUndefined(data)) {
                var data_1 = this.viewerBase.getItemFromSessionStorage('_formDesigner');
                ...
                for (var m_1 = 0; m_1 < FormFieldsData_1.length; m_1++) {
                    if (FormFieldsData_1[parseInt(m_1.toString(), 10)].FormField.id.split("_")[0] == fieldValue.id) {
                        FormFieldsData_1[parseInt(m_1.toString(), 10)].FormField.value = fieldValue.value;
                        FormFieldsData_1[parseInt(m_1.toString(), 10)].FormField.signatureType = fieldValue.signatureType;
