...
export function PdfiumRunner() {
    ...
    ctx.onmessage = function (event) {
        ...
        if (documentDetails) {
            if (event.data.message === 'renderPage') {
                ...
                var data = firstPage.render(null, ImageData_2.zoomFactor, ImageData_2.isTextNeed, null, null, ImageData_2.textDetailsId, null, event.data.cropBoxRect);
                ctx.postMessage(data);
            }
                ...
                var data = firstPage.render(null, ImageData_5.zoomFactor, ImageData_5.isTextNeed, null, null, ImageData_5.textDetailsId);
                ...
                var values = event.data;
                var firstPage = documentDetails.getPage(event.data.pageIndex);
                var data = firstPage.renderTileImage(values.tileX, values.tileY, values.tileXCount, values.tileYCount, values.zoomFactor, event.data.isTextNeed, event.data.textDetailsId, event.data.cropBoxRect);
    ...
    var Page = /** @class */ (function () {
        ...
        Page.prototype.render = function (message, zoomFactor, isTextNeed, printScaleFactor, printDevicePixelRatio, textDetailsId, isTransparent, cropBoxRect) {
        ...
        Page.prototype.renderTileImage = function (x, y, tileX, tileY, zoomFactor, isTextNeed, textDetailsId, cropBoxRect) {
    ...
    var Processor = /** @class */ (function () {
        ...
        Processor.prototype.getRender = function (i, w, h, isTextNeed, isTransparent, cropBoxRect) {
            if (i === void 0) { i = 0; }
        ...
        Processor.prototype.textExtraction = function (pagePointer, pageIndex, isTextNeed, cropBoxRect) {
            var _a;
            if (isTextNeed) {
                ...
                for (var charCount = 0; charCount <= totalCharacterCount; charCount++) {
                    ...
                    var X = this.pointerToPixelConverter(charLeft) - this.pointerToPixelConverter(cropBoxRect.x);
                    var Y = (pageHeight + this.pointerToPixelConverter(cropBoxRect.y)) - this.pointerToPixelConverter(charTop);
        ...
        Processor.prototype.getPageRender = function (n, w, h, isTextNeed, isTransparent, cropBoxRect) {
            if (n === void 0) { n = 0; }
            var pageRenderPtr = this.getRender(n, w, h, isTextNeed, isTransparent, cropBoxRect);
            var pageRenderData = [];
            pageRenderData = PDFiumModule.HEAPU8.slice(pageRenderPtr, pageRenderPtr + (w * h * 4));
            PDFiumModule.asm.free(pageRenderPtr);
            return pageRenderData;
        };
        Processor.prototype.render = function (n, message, zoomFactor, isTextNeed, printScaleFactor, printDevicePixelRatio, textDetailsId, isTransparent, cropBoxRect) {
            if (n === void 0) { n = 0; }
            ...
            if (message === 'thumbnail') {
                ...
                var data = this.getPageRender(n, newWidth, newHeight, isTextNeed, isTransparent, cropBoxRect);
        ...
        Processor.prototype.renderTileImage = function (n, tileX, tileY, xCount, yCount, zoomFactor, isTextNeed, textDetailsId, cropBoxRect) {
            if (n === void 0) { n = 0; }
            var _a = this.getPageSize(n), w = _a[0], h = _a[1];
