...
import { TextLayer, ContextMenu, Signature, AccessibilityTags } from '../index';
...
var PdfViewerBase = /** @class */ (function () {
                ...
                switch (event.keyCode) {
                    ...
                    case 51:
                        {
                            if (event.altKey) {
                                event.preventDefault();
                                if (!isNullOrUndefined(_this.pdfViewer.pageOrganizer) && _this.pageCount > 0 && _this.pdfViewer.enablePageOrganizer) {
                    ...
                    case 65: //"a" key    
                        if (event.shiftKey) {
                            ...
                            event.preventDefault();
                            if (_this.pageCount > 0 && _this.pdfViewer.enableAnnotationToolbar && _this.pdfViewer.toolbarModule && _this.pdfViewer.toolbarModule.annotationToolbarModule) {
    ...
    */
    ...
    PdfViewerBase.prototype.saveDocumentInfo = function () {
        var currentSize = Math.round(JSON.stringify(window.sessionStorage).length / 1024);
    ...
    PdfViewerBase.prototype.saveAsBlobRequest = function () {
        ...
        var promise = new Promise(function (resolve, reject) {
            ...
            if (!isNullOrUndefined(_this.pdfViewer.pageOrganizer) && !isNullOrUndefined(_this.pdfViewer.pageOrganizer.organizePagesCollection)) {
    ...
    */
        ...
        if (this.isDeviceiOS) {
            ...
            if (!this.singleTapTimer) {
                this.singleTapTimer = setTimeout(function () {
                    if (isRemoveFocus_1 && (!isNullOrUndefined(_this.pdfViewer.selectedItems) && !isNullOrUndefined(_this.pdfViewer.selectedItems.annotations[0]))) {
        ...
        if (this.pageCount > 0) {
            ...
            for (var i = 0; i < pageLimit; i++) {
                if (typeof pageValues.pageSizes[parseInt(i.toString(), 10)] !== 'object') {
                    ...
                    // eslint-disable-next-line max-len
                    var size = { width: parseFloat(pageSize[0]), height: parseFloat(pageSize[1]), top: topValue, rotation: !isNullOrUndefined(pageValues.pageRotation) && ((!isNullOrUndefined(pageValues.pageRotation.length) && pageValues.pageRotation.length > 0) || (!isNullOrUndefined(Object.keys(pageValues.pageRotation).length) && Object.keys(pageValues.pageRotation).length > 0)) ? pageValues.pageRotation[parseInt(i.toString(), 10)] : 0 };
                    ...
                    // eslint-disable-next-line max-len
                    var size = { width: (pageValues.pageSizes[parseInt(i.toString(), 10)].width ? pageValues.pageSizes[parseInt(i.toString(), 10)].width : pageValues.pageSizes[parseInt(i.toString(), 10)].Width), height: (pageValues.pageSizes[parseInt(i.toString(), 10)].height ? pageValues.pageSizes[parseInt(i.toString(), 10)].height : pageValues.pageSizes[parseInt(i.toString(), 10)].Height), top: topValue, rotation: !isNullOrUndefined(pageValues.pageRotation) && ((!isNullOrUndefined(pageValues.pageRotation.length) && pageValues.pageRotation.length > 0) || (!isNullOrUndefined(Object.keys(pageValues.pageRotation).length) && Object.keys(pageValues.pageRotation).length > 0)) ? pageValues.pageRotation[parseInt(i.toString(), 10)] : 0 };
                    this.pageSize.push(size);
                }
            ...
            if (proxy.pageSize[proxy.pageLimit - 1]) {
                ...
                for (var i_1 = proxy.pageLimit; i_1 < proxy.pageCount; i_1++) {
                    if (typeof (pageValues.pageSizes[parseInt(i_1.toString(), 10)]) !== 'object') {
                        ...
                        // eslint-disable-next-line max-len
                        var size = { width: parseFloat(pageSize[0]), height: parseFloat(pageSize[1]), top: topValue, rotation: !isNullOrUndefined(pageValues.pageRotation) && ((!isNullOrUndefined(pageValues.pageRotation.length) && pageValues.pageRotation.length > 0) || (!isNullOrUndefined(Object.keys(pageValues.pageRotation).length) && Object.keys(pageValues.pageRotation).length > 0)) ? pageValues.pageRotation[parseInt(i_1.toString(), 10)] : 0 };
                        ...
                        // eslint-disable-next-line max-len
                        var size = { width: (parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].width) ? parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].width) : parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].Width)), height: (parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].height) ? parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].height) : parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].Height)), top: topValue, rotation: !isNullOrUndefined(pageValues.pageRotation) && ((!isNullOrUndefined(pageValues.pageRotation.length) && pageValues.pageRotation.length > 0) || (!isNullOrUndefined(Object.keys(pageValues.pageRotation).length) && Object.keys(pageValues.pageRotation).length > 0)) ? pageValues.pageRotation[parseInt(i_1.toString(), 10)] : 0 };
                        proxy.pageSize.push(size);
                    }
                }
                // eslint-disable-next-line max-len
                        ...
                        image_1.onload = function () {
                            ...
                            if (proxy.tileRenderCount === proxy.tileRequestCount && data.uniqueId === proxy.documentId) {
                                ...
                                for (var i = 0; i < oldPageDiv.length; i++) {
                                    oldPageDiv[parseInt(i.toString(), 10)].src = '';
                        ...
                        for (var i = 0; i < oldCanvases.length; i++) {
                            ...
                            if (parseFloat(tileImgId[tileImgId.length - 3]) != proxy.getZoomFactor()) {
                                if (pageIndex !== parseInt(tileImgId[tileImgId.length - 4], 10)) {
                                    oldCanvases[parseInt(i.toString(), 10)].src = '';
    ...
    PdfViewerBase.prototype.getTileCount = function (pageWidth, pageHeight) {
        if (pageWidth && pageHeight && typeof pageWidth === 'number' && typeof pageHeight === 'number') {
            ...
            var maxTileWidth = 1200;
            var tileCount = 1;
            var tileWidth = pageWidth;
    ...
    PdfViewerBase.prototype.createRequestForRender = function (pageIndex) {
        ...
        if (this.pageSize && this.pageSize[parseInt(pageIndex.toString(), 10)]) {
            ...
            thumbnailImageElement = document.getElementById(this.pdfViewer.element.id + '_thumbnail_Selection_Ring_' + pageIndex);
                            ...
                            if (this.renderThumbnailImages && !this.clientSideRendering) {
                                ...
                                if (this.clientSideRendering) {
                                    ...
                                    if (viewPortWidth_1 >= pageWidth_1 || !proxy.pdfViewer.tileRenderingSettings.enableTileRendering) {
                                        ...
                                        jsonData.action = 'pageRenderInitiate';
                                        proxy.pdfViewer.firePageRenderInitiate(jsonData);
                                        this.pdfViewerRunner.postMessage({ pageIndex: pageIndex, message: 'renderPage', zoomFactor: zoomFactor_3, isTextNeed: isTextNeed, textDetailsId: textDetailsId, cropBoxRect: cropBoxRect });
                                    }
                                    else {
    ...
    */
    ...
    PdfViewerBase.prototype.diagramMouseDown = function (evt) {
        ...
        if ((!isNullOrUndefined(obj)) && (obj.formFieldAnnotationType === "SignatureField" || obj.formFieldAnnotationType === "InitialField")) {
    ...
    PdfViewerBase.prototype.updateAnnotationsUndoRedo = function () {
        var _loop_2 = function (j) {
            ...
            if (proxy.pdfViewer.annotationCollection[j].shapeAnnotationType === "textMarkup") {
                ...
                var pageAnnotations = proxy.pdfViewer.annotation.textMarkupAnnotationModule.getAnnotations(currentAnnotation.pageNumber, null);
                if (pageAnnotations) {
