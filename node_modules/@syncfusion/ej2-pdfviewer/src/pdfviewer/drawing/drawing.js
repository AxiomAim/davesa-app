...
var Drawing = /** @class */ (function () {
    ...
    Drawing.prototype.renderBorder = function (selector, canvas, currentSelector, transform, enableNode, isBorderTickness, isSwimlane, isSticky) {
        ...
        if (!isSticky) {
            ...
            if (currentSelector && (typeof (currentSelector) !== 'object') && currentSelector !== '') {
                ...
                // eslint-disable-next-line max-len
                var lineDash = (isNullOrUndefined(currentSelector.selectorLineDashArray) || (currentSelector.selectorLineDashArray.length === 0)) ? [6, 3] : currentSelector.selectorLineDashArray;
    ...
    Drawing.prototype.getShapeSize = function (type, options, currentSelector, t) {
        if (currentSelector && typeof (currentSelector) !== 'object' && currentSelector !== '') {
            ...
            // eslint-disable-next-line max-len
            options.radius = (isNullOrUndefined(currentSelector.resizerSize) || currentSelector.resizerSize === 8 ? 8 : currentSelector.resizerSize) / 2;
            // eslint-disable-next-line max-len
            options.width = (isNullOrUndefined(currentSelector.resizerSize) || currentSelector.resizerSize === 8 ? 8 : currentSelector.resizerSize) * t.scale;
            // eslint-disable-next-line max-len
            options.height = (isNullOrUndefined(currentSelector.resizerSize) || currentSelector.resizerSize === 8 ? 8 : currentSelector.resizerSize) * t.scale;
        }
        else {
            // eslint-disable-next-line
            var annotationSelector = this.pdfViewer.annotationSelectorSettings;
    ...
    Drawing.prototype.getResizerLocation = function (type, currentSelector) {
        ...
        var resizerLocation;
        {
            if (currentSelector && typeof (currentSelector) !== 'object' && currentSelector !== '') {
                ...
                // eslint-disable-next-line max-len
                resizerLocation = isNullOrUndefined(currentSelector.resizerLocation) || currentSelector.resizerLocation === 3 ? 3 : currentSelector.resizerLocation;
            }
            else {
                // eslint-disable-next-line
                var annotationSelector = this.pdfViewer.annotationSelectorSettings;
