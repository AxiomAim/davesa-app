...
var TextSelection = /** @class */ (function () {
        ...
        this.onLeftTouchSelectElementTouchMove = function (event) {
            ...
            if (rightElement && isTouchedWithinViewerContainer) {
                ...
                if (nodeElement) {
                    ...
                    // eslint-disable-next-line max-len
                    var textHeight = zoomFactor > 1 ? zoomFactorabovehundard : zoomFactor > 0.7 ? zoomFactorAboveSeventy : zoomFactor > 0.5 ? zoomFactoraboveFifty : zoomFactorbelowFifty;
                    // eslint-disable-next-line max-len
        ...
        this.onRightTouchSelectElementTouchMove = function (event) {
            ...
            if (leftElement && isTouchedWithinViewerContainer) {
                ...
                if (nodeElement) {
                    ...
                    // eslint-disable-next-line max-len
                    var textHeight = zoomFactor > 1 ? (zoomFactor * zoomFactorabovehundard) : (zoomFactor > 0.7 ? zoomFactorAboveSeventy : (zoomFactor > 0.5 ? zoomFactoraboveFifty : zoomFactorbelowFifty));
                    // eslint-disable-next-line max-len
    ...
    TextSelection.prototype.createTouchSelectElement = function (event) {
        ...
        if (selection.type === 'Range') {
            ...
            // eslint-disable-next-line max-len
            var dropElementTop = this.pdfViewerBase.getZoomFactor() > 2 ? dropTopAboveTwoHundred : this.pdfViewerBase.getZoomFactor() > 1 ? dropTopAboveHundard : 0;
            // eslint-disable-next-line max-len
