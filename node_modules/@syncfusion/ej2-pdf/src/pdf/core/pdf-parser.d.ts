...
export declare class _PdfParser {
    ...
    private _isPassword;
    constructor(lexicalOperator: _PdfLexicalOperator, xref: _PdfCrossReference, allowStreams?: boolean, recoveryMode?: boolean);
    refill(): void;
    shift(): void;
    tryShift(): boolean;
    ...
    makeInlineImage(cipherTransform?: _CipherTransform): any;
