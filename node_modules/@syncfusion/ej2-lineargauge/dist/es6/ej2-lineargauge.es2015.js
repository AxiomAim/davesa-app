import { Animation, Browser, ChildProperty, Collection, Complex, Component, Event, EventHandler, Internationalization, NotifyPropertyChanges, Property, SanitizeHtmlHelper, animationMode, compile, createElement, isNullOrUndefined, merge, print, remove } from '@syncfusion/ej2-base';
...
class AxisRenderer extends Animations {
    ...
    updateTextPointer(pointerId, pointer, axis) {
        ...
        const textElement$$1 = document.getElementById(pointerId);
        textElement$$1.setAttribute('x', textOptions.x.toString());
        textElement$$1.setAttribute('y', textOptions.y.toString());
        textElement$$1.textContent = pointer.text;
    }
    /**
     * @private
     */
...
class GaugeTooltip {
    ...
    renderTooltip(e) {
        ...
        else if ((target.id === (this.element.id + '_LinearGaugeTitle')) && (event.target.textContent.indexOf('...') > -1)) {
    ...
    svgCreate(svgTooltip, args, gauge, areaRect, fill, template, tooltipPos, location, target, textStyle) {
        ...
        svgTooltip = new Tooltip({
            ...
            areaBounds: new Rect((this.gauge.orientation === 'Vertical') ? location.x : areaRect.left, (this.gauge.orientation === 'Vertical') ? areaRect.top : (tooltipPos === 'Bottom') ? areaRect.top : location.y, tooltipPos === 'Right' ? Math.abs(areaRect.left - location.x) : areaRect.width, areaRect.height),
            textStyle: textStyle,
    ...
    render() {
        ...
        if (this.allowLoadingAnimation) {
            ...
            if (styleClass.length === 0) {
                ...
                styleClass.innerText = '.' + this.element.id + 'animation' + '{opacity: 0}';
