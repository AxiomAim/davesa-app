...
// -----------------------------------------------------------------------------------------------------
// @ DAVESA TailwindCSS Main Plugin
// -----------------------------------------------------------------------------------------------------
            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `davesa.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `davesa.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--davesa-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--davesa-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
