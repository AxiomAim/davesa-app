...
export class DavesaNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, DavesaNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: DavesaNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): DavesaNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: DavesaNavigationItem[],
        flatNavigation: DavesaNavigationItem[] = []
    ...
    getItemParent(
        id: string,
        navigation: DavesaNavigationItem[],
        parent: DavesaNavigationItem[] | DavesaNavigationItem
    ): DavesaNavigationItem[] | DavesaNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
