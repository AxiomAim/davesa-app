...
@Component({
    selector: 'davesa-vertical-navigation-collapsable-item',
    ...
    imports: [
        ...
        forwardRef(() => DavesaVerticalNavigationCollapsableItemComponent),
...
export class DavesaVerticalNavigationCollapsableItemComponent
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'davesa-vertical-navigation-item-collapsed': this.isCollapsed,
            'davesa-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._davesaVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._davesaVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._davesaVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._davesaVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
