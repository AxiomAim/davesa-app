...
import { DavesaHighlightService } from '@davesa/components/highlight/highlight.service';

@Component({
    selector: 'textarea[davesa-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'davesaHighlight',
    standalone: true,
    imports: [NgClass],
})
export class DavesaHighlightComponent implements OnChanges, AfterViewInit {
    private _domSanitizer = inject(DomSanitizer);
    private _elementRef = inject(ElementRef);
    private _davesaHighlightService = inject(DavesaHighlightService);
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._davesaHighlightService.highlight(this.code, this.lang)
        );
