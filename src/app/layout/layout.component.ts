...
import { DavesaConfig, DavesaConfigService } from '@davesa/services/config';
...
import { DAVESA_VERSION } from '@davesa/version/davesa-version';
...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _davesaPlatformService: DavesaPlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            ...
            this._davesaMediaWatcherService.onMediaQueryChange$([
        ...
        this._renderer2.addClass(
            this._document.body,
            this._davesaPlatformService.osName
        );
    }
