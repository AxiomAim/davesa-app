...
export class MyEconsentModel {
    ...
    public static emptyDto(): MyEconsentDto {
    ...
    public static toDto(dto: MyEconsentDto): MyEconsentDto {
...
export interface MyEconsentDto extends BaseDto {
    id: string,
    orgId: string,
    projectId: string,
    sort: number,
