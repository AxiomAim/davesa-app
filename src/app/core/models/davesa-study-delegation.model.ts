...
export class DavesaStudyDelegationModel extends BaseDatabaseModel {
    ...
    public static toDto(dto: DavesaStudyDelegationDto): DavesaStudyDelegationDto {
    ...
    public static emptyDto(): DavesaStudyDelegationDto {
        const datetime = new Date().toISOString();
        return {
            id: uuidv4().toString(),
            studyName: null,
...
export interface DavesaStudyDelegationDto extends BaseDto {
  id: string,
  studyName: string,
  studyProtocolNumber: string,
  studyProtocolTitle: string,
