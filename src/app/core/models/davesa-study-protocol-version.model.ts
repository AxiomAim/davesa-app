...
export class DavesaStudyProtocolVersionModel extends BaseDatabaseModel {
    ...
    public static toDto(dto: DavesaStudyProtocolVersionDto): DavesaStudyProtocolVersionDto {
    ...
    public static emptyDto(): DavesaStudyProtocolVersionDto {
        const datetime = new Date().toISOString();
        return {
            id: uuidv4().toString(),
            studyName: null,
...
export interface DavesaStudyProtocolVersionDto extends BaseDto {
  id: string,
  studyName: string,
  studyProtocolNumber: string,
  studyProtocolTitle: string,
