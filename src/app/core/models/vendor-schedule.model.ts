...
export class VendorScheduleModel {
    ...
    public static emptyDto(): VendorScheduleDto {
    ...
    public static toDto(dto: VendorScheduleDto): VendorScheduleDto {
...
export interface VendorScheduleDto extends BaseDto {
    id: string,
    orgId: string,
    sort: number,
    category: string,
