...
export class DavesaStudyDelegationRoleModel extends BaseDatabaseModel {
    ...
    public static toDto(dto: DavesaStudyDelegationRoleDto): DavesaStudyDelegationRoleDto {
    ...
    public static emptyDto(): DavesaStudyDelegationRoleDto {
        const datetime = new Date().toISOString();
        return {
            id: uuidv4().toString(),
            studyName: null,
...
export interface DavesaStudyDelegationRoleDto extends BaseDto {
  id: string,
  studyName: string,
  studyProtocolNumber: string,
  studyProtocolTitle: string,
