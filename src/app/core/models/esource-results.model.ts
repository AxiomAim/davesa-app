...
export class EsourceResultsModel {
    constructor(
        id: string,
        orgId: string,
        esourceId: string,
    ...
    public static toDto(dto: EsourceResultsDto): EsourceResultsDto {
        return {
            id: dto.id,
            orgId: dto.orgId,
    ...
    public static emptyDto(): EsourceResultsDto {
...
export interface EsourceResultsDto extends BaseDto {
    id: string;
    orgId: string;
    esourceId: string;
    json?: any;
