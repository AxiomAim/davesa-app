...
export class CsvProtocolModel {
    ...
    public static emptyDto(): CsvProtocolDto {
    ...
    public static toDto(dto: CsvProtocolDto): CsvProtocolDto {
...
export interface CsvProtocolDto extends BaseDto {
    id: string,
    orgId: string,
    projectId: string,
    sort: number,
