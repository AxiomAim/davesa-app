...
export class DavesaStudyModel extends BaseDatabaseModel {
    ...
    public static toDto(dto: DavesaStudyDto): DavesaStudyDto {
    ...
    public static emptyDto(): DavesaStudyDto {
        const datetime = new Date().toISOString();
        return {
            id: uuidv4().toString(),
            studyName: null,
...
export interface DavesaStudyDto extends BaseDto {
  id: string,
  studyName: string,
  studyProtocolNumber: string,
  studyProtocolTitle: string,
