...
// export const defaultNavigation: DavesaNavigationItem[] = [
//     {
//         id: 'dashboards',
//         title: 'Dashboards',
...
export const defaultNavigation: DavesaNavigationItem[] = [
    {
                id: 'atlanta',
                title: 'Atlanta',
                tooltip: 'Atlants Studies',
                type: 'aside',
                icon: 'davesaicons_solid:studies',
                accessCondition: [    
                    UserRoleEnum.admin,
                    UserRoleEnum.monitor,
                    UserRoleEnum.onsite,
    ...
    },
    {
        ...
        subtitle: 'Organization Admin Tools',
        type: 'group',
        ...
        children: [
            ...
            // },
            // {
            //     id: 'administration.study-admin',
            //     title: 'Study Admin',
            //     type: 'basic',
            //     icon: 'mat_solid:construction',
            //     link: '/apps/study-admin',
            // },
            // {
            //     id: 'administration.study-constructor',
            //     title: 'Study Constructor',
            //     type: 'basic',
            //     icon: 'mat_solid:construction',
            //     link: '/apps/study-constructor',
            // },
            {
                id: 'administration.global-lists',
                title: 'Global Lists',
                type: 'collapsable',
                icon: 'mat_solid:view_list',
                children: [
                    {
                        id: 'administration.global-lists.sponsors',
                        title: 'Sponsors',
                        type: 'basic',
                    ...
                    {
                        id: 'administration.global-lists.cros',
                        title: 'CROs',
                        type: 'basic',
                        icon: 'mat_solid:medication',
                        link: '/apps/cros',
                    ...
                    {
                        id: 'administration.global-lists.irbs',
                        title: 'IRBs',
                        type: 'basic',
                        icon: 'mat_solid:medication',
                        link: '/apps/irbs',
    ...
    },
    {
        ...
        children: [
            ...
            {
                id: 'apps.participants',
                title: 'Participants',
                type: 'basic',
                icon: 'mat_solid:supervised_user_circle',
                link: '/apps/participants',
            },
            {
                id: 'apps.studies',
                title: 'Studies',
...
export const compactNavigation: DavesaNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'Dashboards',
        tooltip: 'Dashboards',
...
export const futuristicNavigation: DavesaNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'DASHBOARDS',
        type: 'group',
...
export const horizontalNavigation: DavesaNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'Dashboards',
        type: 'group',
