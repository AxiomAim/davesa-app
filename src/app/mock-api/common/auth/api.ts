...
export class AuthMockApi {
    private _authDavesaSignalService = inject(AuthDavesaApiService);
    public _user: any = this._authDavesaSignalService.user();
    ...
    registerHandlers(): void {
        ...
        this._davesaMockApiService
            ...
            .reply(({ request }) => {
                // Sign in successful
                // if (
                //     request.body.email === 'tom@davesa.com' &&
        ...
        // @ Sign up - POST
        // -----------------------------------------------------------------------------------------------------
        this._davesaMockApiService.onPost('api/auth/sign-up', 1500).reply(() =>
            // Simply return true
            [200, true]
        );
