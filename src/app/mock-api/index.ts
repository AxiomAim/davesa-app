...
import { ClinicMockApi } from './dashboards/clinic/api';
import { VisitMockApi } from './apps/visit/api';
import { SponsorsMockApi } from './apps/sponsors/api';
import { CrosMockApi } from './apps/cros/api';
import { IrbsMockApi } from './apps/irbs/api';
import { ParticipantsMockApi } from './apps/participants/api';
import { UsersMockApi } from './apps/users/api';
import { VksktStatusMockApi } from './common/visit-status/api';
