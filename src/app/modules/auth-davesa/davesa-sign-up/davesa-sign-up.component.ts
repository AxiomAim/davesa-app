...
@Component({
    selector: 'auth-davesa-sign-up',
    templateUrl: './davesa-sign-up.component.html',
...
export class AuthDavesaSignUpComponent implements OnInit {
    ...
    signUp(): void {
        ...
        // Sign up
        // this._authService.login(this.signUpForm.value).subscribe(
        //     (response) => {
