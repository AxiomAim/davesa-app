...
export class StudyAdminDetailsComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _studyAdminListComponent: StudyAdminListComponent,
    ...
    ngOnInit(): void {
        // Open the drawer
        this._studyAdminListComponent.matDrawer.open();
    ...
    closeDrawer(): Promise<MatDrawerToggleResult> {
        return this._studyAdminListComponent.matDrawer.close();
    }
