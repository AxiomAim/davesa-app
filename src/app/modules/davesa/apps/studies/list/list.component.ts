...
export class StudiesListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.studies$ = this._studiesService.studies$;
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) =>
                    // Search
                    this._studiesService.searchStudies(query)
                )
            )
            .subscribe();
     ...
     */
    createStudy(): void {
        // const newStudy = this._studiesService.createStudy()
        // newStudy
        //     .pipe(takeUntil(this._unsubscribeAll))
        //     .subscribe((study: Study) => {
    ...
    selectedRow(event: any) {
        this._router.navigate(['apps/studies/', event.data.oid])
    }
