...
import { ParticipantVisitsComponent } from './participant-visits/participant-visits.component';

@Component({
    selector: 'studies-details',
    ...
    imports: [
        ...
        MatTabsModule,
        ParticipantVisitsComponent
    ],
})
export class StudiesDetailsComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _studiesListComponent: StudiesListComponent,
    ...
    ngOnInit(): void {
        // Open the drawer
        this._studiesListComponent.matDrawer.open();


        // Get the studies
        this._studiesService.studies$
    ...
    closeDrawer(): Promise<MatDrawerToggleResult> {
        return this._studiesListComponent.matDrawer.close();
    }
    ...
    openMailbox(study: any) {
        console.log('getStudy', this._studiesService.getStudy())
        this._studiesService.setToStorage();
        this._router.navigate(["apps/mailbox"], {
            queryParams: {
              study_oid: study.oid,
            },
            preserveFragment: true,
