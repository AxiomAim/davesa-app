...
import { MailboxComposeComponent } from 'app/modules/davesa/apps/mailbox/compose/compose.component';
import { labelColorDefs } from 'app/modules/davesa/apps/mailbox/mailbox.constants';
...
@Component({
    ...
    standalone: true,
    imports: [MatButtonModule, MatIconModule, DavesaVerticalNavigationComponent],
})
