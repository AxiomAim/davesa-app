...
import { MailboxDetailsComponent } from 'app/modules/davesa/apps/mailbox/details/details.component';
import { MailboxEmptyDetailsComponent } from 'app/modules/davesa/apps/mailbox/empty-details/empty-details.component';
import { MailboxListComponent } from 'app/modules/davesa/apps/mailbox/list/list.component';
import { MailboxComponent } from 'app/modules/davesa/apps/mailbox/mailbox.component';
import { MailboxService } from 'app/modules/davesa/apps/mailbox/mailbox.service';
import { MailboxSettingsComponent } from 'app/modules/davesa/apps/mailbox/settings/settings.component';
...
const studyResolver = (
    ...
    return mailboxService.getStudy(route.paramMap.get('oid')).pipe(
...
export default [
    ...
    },
    {
        ...
        resolve: {
            mails: () => inject(MailboxService).getAllMail(),
