...
@Component({
    selector: 'study-constructor-list',
...
export class StudyConstructorListComponent implements OnInit, OnDestroy {
    ...
    tableView() {
        this._router.navigate(["apps/study-constructor/table"], {
            queryParams: {
            },
