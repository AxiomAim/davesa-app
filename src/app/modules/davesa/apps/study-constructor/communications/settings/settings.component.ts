...
import {
    labelColorDefs,
    labelColors,
} from 'app/modules/davesa/apps/participants/communications/communications.constants';
import { CommunicationsService } from 'app/modules/davesa/apps/participants/communications/communications.service';
import { CommunicationLabel } from 'app/modules/davesa/apps/participants/communications/communications.types';
...
export class CommunicationsSettingsComponent implements OnInit {
    ...
    deleteLabel(id: string): void {
        ...
        this._communicationsService.deleteLabel(id).subscribe();
    }
